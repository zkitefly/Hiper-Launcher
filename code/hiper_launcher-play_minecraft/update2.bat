...
%appdata%\hiper_launcher-play_minecraft\wget.exe -q -N -T 5 -P %appdata%\hiper_launcher-play_minecraft -S -t 100 https://gitee.com/bleaker/hiper-launcher/raw/main/code/hiper_launcher-play_minecraft/v.txt
