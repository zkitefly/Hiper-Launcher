...
%appdata%\hiper_launcher-play_minecraft\wget.exe  -q -P %appdata%\hiper_launcher-play_minecraft\experience -S -N -t 5 -o %appdata%\hiper_launcher-play_minecraft\home.bat-update3.log https://zkitefly.github.io/Hiper-Launcher/code/home.bat
